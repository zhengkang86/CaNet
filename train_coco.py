...
# trainset
dataset = COCO_CaNet(coco_dir, 'train2017', folds, 1, normalize_mean=IMG_MEAN, normalize_std=IMG_STD)
...
valset = COCO_CaNet(coco_dir, 'val2017', folds, 1, normalize_mean=IMG_MEAN, normalize_std=IMG_STD)
